<!DOCTYPE html>
<html lang="en">
<!-- Mirrored from flatfull.com/themes/todo/ by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 23 Sep 2015 08:48:15 GMT -->
        @section('head')
            This is the master head.
        @show
<body>
<section class="hbox stretch">
  ...
  <section id="content">
    <section class="vbox">
        ...
        @show
      <section id="pnafrikcontent" class="scrollable wrapper">
        <div class="row">
          <div class="col-lg-8">
            <section class="panel">
              <form>
...
<!-- Mirrored from flatfull.com/themes/todo/ by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 23 Sep 2015 08:48:30 GMT -->
</html>

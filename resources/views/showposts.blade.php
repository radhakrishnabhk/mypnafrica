                      ...
                      <div class="panel-body">
                        <div class="row">
                          ...
                          <div class="col-xs-12 col-sm-5 col-md-7 col-lg-7">
                            <h4><a href="catagories3.html">PnAfrik PnAfrik PnAfrik PnAfrik...</a></h4>
                            <br>
                            <footer class="panel-footer pos-rlt"> <span class="arrow top"></span>
                              ...
                              <span><i class="fa fa-inbox"></i>Posted in Jokes</span> </footer>
                          </div>
                          <div class="col-xs-12 col-sm-2 col-md-2 col-lg-2">
                            <ul class="list-group no-radius" style="margin-top:5px;">
                              <li class="list-group-item text-center  bg-success"></i> Replies (0) </li>
                              <li class="list-group-item text-center  bg-warning">Views (10) </li>
                              <li class="list-group-item text-center  bg-danger">Votes (10) </li>
                              <li class="list-group-item text-center  bg-gradient">Likes (10) </li>
                            </ul>
                          </div>
                          <span class="text-muted m-l-sm pull-right"> <i class="fa fa-clock-o"></i> 24 minutes ago </span> </div>
                      </div>
                    </section>
                  </div>
                </div>
                <div class="row" id="two">
                  <div class="col-lg-12 col-sm-12">
                    <section class="panel" style="border-left: 2px solid #fb6b5b;">
                      <div class="panel-body">
                        <div class="row">
                          <div class="col-xs-12 col-sm-5 col-md-3 col-lg-3"> <a href="adsinside.html" class="thumbnail"> <img src="images/avatar.jpg" alt="..."> </a>
                            <div align="center"><strong> McSmith</strong></div>
                            <div class="text-center"><i class="fa fa-circle text-danger"></i>offline</div>
                            <div class="text-center"><a href="#" class="btn bg-dark"><i class="fa fa-envelope-o"></i>PM</a></div>
                          </div>
                          ...
                          <div class="col-xs-12 col-sm-2 col-md-2 col-lg-2">
                            <ul class="list-group no-radius" style="margin-top:5px;">
                              <li class="list-group-item text-center  bg-success"> Replies (0) </li>
                              <li class="list-group-item text-center  bg-warning">Views (10) </li>
                              <li class="list-group-item text-center  bg-danger">Votes (10) </li>
                              <li class="list-group-item text-center  bg-gradient">Likes (10) </li>
                            </ul>
